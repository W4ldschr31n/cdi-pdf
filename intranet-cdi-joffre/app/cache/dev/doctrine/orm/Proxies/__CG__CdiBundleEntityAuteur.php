 ...
 */
class Auteur extends \CdiBundle\Entity\Auteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CdiBundle\\Entity\\Auteur' . "\0" . 'id', '' . "\0" . 'CdiBundle\\Entity\\Auteur' . "\0" . 'prenom', '' . "\0" . 'CdiBundle\\Entity\\Auteur' . "\0" . 'nom');
        }
